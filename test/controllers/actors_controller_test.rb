...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post actors_url, params: { actor: { birth_date: @actor.birth_date, decription: @actor.decription, first_name: @actor.first_name, last_name_string: @actor.last_name_string } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { birth_date: @actor.birth_date, decription: @actor.decription, first_name: @actor.first_name, last_name_string: @actor.last_name_string } }
